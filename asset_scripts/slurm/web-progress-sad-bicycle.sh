...
#SBATCH --job-name=web-progress-sad-bicycle
#SBATCH --output=/export/scratch/ra28kuc/slurm_logs/web-progress-sad-bicycle-%j.log

# Webpage asset: SAD FINAL config on bicycle with dense --save_iterations
# for the training-progress video. Same flags as the flowers run.
# Reference run: newproj-sad_v1.7-bicycle-s0-FINAL (PSNR 25.76, N 2.95M).
...
M=/export/scratch/ra28kuc/output/web-progress-sad-bicycle
