...
#SBATCH --job-name=web-progress-sad-truck
#SBATCH --output=/export/scratch/ra28kuc/slurm_logs/web-progress-sad-truck-%j.log

# Webpage asset: SAD FINAL config on truck with dense --save_iterations for
...
M=/export/scratch/ra28kuc/output/web-progress-sad-truck
...
python train.py \
  ...
  --wandb_run_name "web-progress-sad-truck" \
