...
#SBATCH --job-name=web-progress-3dgs-drjohnson
#SBATCH --output=/export/scratch/ra28kuc/slurm_logs/web-progress-3dgs-drjohnson-%j.log

# Webpage asset: 3DGS baseline on drjohnson with dense --save_iterations.
set -euo pipefail
...
M=/export/scratch/ra28kuc/output/web-progress-3dgs-drjohnson
...
python train.py \
  ...
  --wandb_run_name "web-progress-3dgs-drjohnson" \
